...
const TabsAndroid = () => {
  return (
    ...
    >
      ...
      <AndroidBottomTab.Screen name="Tab2Screen" options={{ title: 'Tab 2' }} component={Tab2Screen} />
...
export const TabsIOS = () => {
  return (
    ...
    >
      ...
      <IOSBottomTab.Screen name="Tab2Screen" options={{ title: 'Tab 2' }} component={Tab2Screen} />
